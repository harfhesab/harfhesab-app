...
export const saveCompletedPartAndSentenceBuildedInKalamAkhar = (
    ...
    try {
        ...
        const challenge = realm.objectForPrimaryKey<KalamAkharChallenge>("KalamAkharChallenge", challengeObjectId);
...
export const saveMainWordBuildedInKalamAkharChallenge = (
    realm: Realm,
    challengeId: BSON.ObjectId | string,
    partIndex: number,
...
export const saveNewAdditionalWordsBuildedInKalamAkharChallenge = (
    realm: Realm,
    challengeId: BSON.ObjectId | string,
    partIndex: number,
    wordId: BSON.ObjectId | string,
...
export const saveNewHiddenWordsBuildedInKalamAkharChallenge = (
    realm: Realm,
    challengeId: BSON.ObjectId | string,
    partIndex: number,
    wordId: BSON.ObjectId | string,
...
export const saveUnknownWordCompletedInKalamAkharChallenge = (
    realm: Realm,
    challengeId: BSON.ObjectId | string,
    partIndex: number,
    wordId: BSON.ObjectId | string,
