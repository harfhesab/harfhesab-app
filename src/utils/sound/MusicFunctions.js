...
// ================================= Stage Game Music ================================================================
export const useStageListStageGameMusic = (volume = 0.1) => useBackgroundMusic('music_stage_list.ogg', volume);
export const useWordToSlotStageGameMusic = (volume = 0.03) => useBackgroundMusic('music_word_to_slot.ogg', volume);
export const useConnectingLetterStageGameMusic = (volume = 0.15) => useBackgroundMusic('music_connecting_letter.ogg', volume);
// ================================= Package Game Music ==============================================================
export const useSeasonListPackageGameMusic = (volume = 0.04) => useBackgroundMusic('music_season_list.ogg', volume);
export const useStageListPackageGameMusic = (volume = 0.1) => useBackgroundMusic('music_stage_list.ogg', volume);
export const useWordToSlotPackageGameMusic = (volume = 0.03) => useBackgroundMusic('music_word_to_slot.ogg', volume);
