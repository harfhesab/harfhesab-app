...
import KalamAkhar from './KalamAkhar';
import KalamAkharPlaying from './KalamAkharPlaying';
...
const TAB_CONFIG = [
  ...
  {
    name: 'KalamAkharPlaying',
    component: KalamAkharPlaying,
    label: 'شروع شده',
...
const KalamAkharBottomTab = () => {
  ...
  return (
    <Tab.Navigator initialRouteName="KalamAkhar" screenOptions={screenOptions}>
...
export default KalamAkharBottomTab;