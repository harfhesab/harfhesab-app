...
function ButtonBorder(
    {loading, loadingType, onPress, borderRadius, borderWidth, borderColor, width, height, text, text2, icon, complateContent, textSize, fontFamily, justifyContent, activeOpacity}
){
