...
export const FONT_SIZE_FLOATING = CARD_SIZE_FLOATING/4.5; // فونت سایز در حالت شناور
export const FONT_SIZE_DRAGGING = CARD_SIZE_DRAGGING/4.5; // فونت سایز در حالت درگ
