...
export const FONT_SIZE_DRAGGING = CARD_SIZE_DRAGGING / 1.55;
export const FONT_SIZE_ATTACHED = CARD_SIZE_ATTACHED / 1.55;
...
export const MAGNET_DELAY = 200; // تأخیر 250 میلی‌ثانیه برای چسبیدن کارت
export const ATTACH_OFFSET_X = 2; // اختلاف 3 پیکسل در محور x
export const ATTACH_OFFSET_Y = 2; // اختلاف 3 پیکسل در محور y
export const SPRING_CONFIG_MAGNET = { stiffness: 300, damping: 10, mass: 0.9, overshootClamping: false };
...
export const FOLLOW_DELAY = 5; // تأخیر (میلی‌ثانیه) برای حرکت دنباله‌دار هر کارت
