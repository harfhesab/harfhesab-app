...
function HarfAkharChallenge({
    ...
    const cardImageTitle = subscription_required == true?
        require("../../../assets/image/harf-akhar-title-2.png"):
        require("../../../assets/image/harf-akhar-title-1.png")
    ...
    const click = ()=>{
        if(is_active == true){
            ...
            showToast({
                ...
                message: "در حال حاضر این چالش حرف‌ آخر غیر فعال است.",
                type: "info",
                animationType: "slide",
                position: "top",
                duration: 6000
...
export default memo(HarfAkharChallenge, areEqual);