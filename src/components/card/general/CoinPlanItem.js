        ...
        <View style={{alignItems:'center', justifyContent:'center'}}>
            ...
            >
                <View style={{flexDirection:'column', alignItems:'center', justifyContent:"space-between", width:"100%", height:"100%"}}>
                    ...
                    <View>
                        <Text numberOfLines={2} style={{fontFamily:Font.bakh_bold, color:colors.primary.a3, fontSize:16, textAlign:"center"}}>{`${priceDigitSeperator(numberCoin)} سکه`}</Text>
...
export default memo(CoinPlanItem)