...
export const SLOT_NUMBER_IN_ROW = 8; // تعداد اسلات در یک ردیف
...
export const BOUNDARY_HORIZONTAL_OFFSET = 40; // فاصله محدوده از چپ و راست
...
export const BOUNDARY_HEIGHT = (height - 120)*0.7-150;
